...
export class PhysicsWorld {
  ...
  #resolveCollision(bodyA, bodyB, collision) {
    ...
    const moveA = normal.multiply(
      -penetration * (bodyA.invMass / totalInvMass)
    );
    ...
    if (!bodyA.isStatic)
      bodyA.velocity = bodyA.velocity.subtract(impulse.multiply(bodyA.invMass));
    if (!bodyB.isStatic)
      bodyB.velocity = bodyB.velocity.add(impulse.multiply(bodyB.invMass));
  }
}
